...
describe('SyncedTemplate helpers', () => {
  ...
  describe('additionalInfo', () => {
    ...
    it('renders name as link when template has id and canEdit', () => {
      ...
      expect(nameItem.props.template.canEdit).toBe(true);
      expect(nameItem.props.template.id).toBe(1);
    });
